...
if(isset($_POST['oldPass']) && isset($_POST['newPass']) && isset($_POST['confirmPass'])){
	...
	$query = 'SELECT `adminId`, `salt` FROM '.$glob['dbprefix'].'CubeCart_admin_users WHERE `adminId`='.$db->mySQLSafe($ccAdminData['adminId']);
...
<table border="0" align="center" cellpadding="3" cellspacing="1" class="mainTable">
  ...
  <tr>
    ...
    <td><input name="oldPass" type="password" autocomplete="off" id="oldPass" class="textbox" /></td>
  </tr>
  <tr>
    <td class="tdText"><?php echo $lang['admin']['adminusers_new_pass']; ?></td>
    <td><input name="newPass" type="password" autocomplete="off" id="newPass" class="textbox" /></td>
  </tr>
  <tr>
    <td class="tdText"><?php echo $lang['admin']['adminusers_confirm_pass']; ?></td>
    <td><input name="confirmPass" type="password" autocomplete="off" id="confirmPass" class="textbox" /></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
