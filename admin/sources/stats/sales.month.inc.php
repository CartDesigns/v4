...
<p class='pageTitle'><?php echo $lang['admin']['stats_daily_sales'];?></p>
<p class='copyText'><?php echo $lang['admin']['stats_by_month'];?>
...
$query = "SELECT prod_total, cart_order_id FROM `".$glob['dbprefix']."CubeCart_order_sum` WHERE cart_order_id>'".$sqlMonth."01-000000-0000' AND cart_order_id<'".$sqlMonth."31-999999-9999' AND `status` = 3 ORDER BY cart_order_id ASC;";
...
for($i = 0, $maxi = count($month); $i < $maxi; ++$i){
