...
<p class='pageTitle'><?php echo $lang['admin']['stats_hourly_sales'] ;?></p>
...
$query = "SELECT prod_total, cart_order_id FROM `".$glob['dbprefix']."CubeCart_order_sum` WHERE cart_order_id>'".$sqlDay."-000000-0000' AND cart_order_id<'".$sqlDay."-999999-9999' AND `status` = 3 ORDER BY cart_order_id ASC;";
...
for($i = 0, $maxi = count($day); $i < $maxi; ++$i){
