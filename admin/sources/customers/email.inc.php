...
?>
<p class="pageTitle"><?php echo $lang['admin']['customers_email_customers']; ?></p>
...
<table width="100%"  border="0" cellspacing="1" cellpadding="3" class="mainTable">
  <tr>
    <td colspan="2" class="tdTitle"><?php echo $lang['admin']['customers_create_email']; ?></td>
  </tr>
  <tr>
...
?></td>
  ...
  <tr>
    ...
    <td><textarea name='plain_text' style='width: 100%;' rows='14'><?php echo stripslashes($_POST['plain_text']); ?></textarea></td>
  </tr>
  <tr>
    <td class="tdRichText"><span class="tdText"><em><strong><?php echo $lang['admin']['customers_hint']; ?></strong> </em></span></td>
    <td class="tdRichText"><span class="tdText"><em><?php echo $lang['admin']['customers_click_source']; ?></em></span></td>
  </tr>
  <tr>
    <td valign="top" class="tdRichText"><span class="tdText"><em><strong><?php echo $lang['admin']['customers_important']; ?></strong></em></span></td>
    <td class="tdRichText"><span class="tdText"><em><?php echo $lang['admin']['customers_absolute_links']; ?></em> </span>
...
?>
<p class="copyText"><?php echo $lang['admin']['customers_download_or_send']; ?></p>
<table width="450" border="0" align="center" cellpadding="3" cellspacing="1" class="mainTable">
  <tr>
    <td colspan="2" class="tdTitle"><?php echo $lang['admin']['customers_please_choose']; ?></td>
  </tr>
  <tr>
