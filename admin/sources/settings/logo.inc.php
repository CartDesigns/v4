...
foreach ($skinList as $folder) {
  ...
  <tr>
	...
	<td align="center" class='<?php echo $cellColor ?> copyText'><img src='<?php echo $GLOBALS['rootRel'] ?>skins/<?php echo $folder ?>/styleImages/logo/default.gif' alt='' /><br /></td>
	...
	if (file_exists($custom)) {
		...
		?>
		<img src='images/getLogo.php?skin=<?php echo $folder ?>' alt='' />
		<?php
	} else if (file_exists($default)) {
		$defaultImg = 1;
		?>
		<img src='<?php echo $GLOBALS['rootRel'] ?>skins/<?php echo $folder ?>/styleImages/logo/default.gif' alt='' />
		<?php
	} else {
