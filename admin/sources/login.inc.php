...
<div style="margin: auto; width: 285px; padding-top: 10px; text-align: right;" class="copyrightText">Copyright <a href="http://www.CubeCart.com" target="_blank" class="copyrightText">CubeCart Limited</a> <?php echo  date("Y");?>.<br />All rights reserved.</div>