...
<div style="padding: 10px;">
{VAL_DELIVERY_NAME}<br />
{VAL_DELIVERY_COMPANY_NAME}<br />
...
<tr>
<td colspan="2" align="left" valign="top"><strong>{LANG_CUSTOMER_COMMENTS}</strong> <div style="padding: 10px;">&quot;{VAL_CUSTOMER_COMMENTS}&quot;</div></td>
</tr>
...
<!-- BEGIN: digital_link -->
<br />
[<a href="{VAL_DOWNLOAD_LINK}" class="txtLink">{LANG_DOWNLOAD_LINK}</a>]
<!-- END: digital_link -->		
</td>
...
<td align="right" class="btmSubNav" style="border-top: 1px solid #000000;"><strong>{VAL_GRAND_TOTAL}</strong></td>
</tr>
</table></td>
</tr>
</table>
