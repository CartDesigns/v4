<!-- BEGIN: view_orders -->
	...
	<div>	
		...
		<table width="100%" border="0" cellpadding="3" cellspacing="0" style="margin-bottom: 25px;">
		  ...
		  <!-- BEGIN: repeat_orders -->
		  <tr>
		    <td align="center" class="{TD_CART_CLASS}"><a href="index.php?_g=co&amp;_a=viewOrder&amp;cart_order_id={DATA.cart_order_id}" class="txtSession">{DATA.cart_order_id}</a></td>
			<td align="center" class="{TD_CART_CLASS}">{VAL_STATE}</td>
			<td align="center" class="{TD_CART_CLASS}">{VAL_DATE_TIME}</td>
			<td align="center" class="{TD_CART_CLASS}"><a href="index.php?_g=co&amp;_a=viewOrder&amp;cart_order_id={DATA.cart_order_id}" class="txtSession">{LANG_VIEW_ORDER}</a>
			<!-- BEGIN: make_payment -->
			<br />
			<a href="index.php?_g=co&amp;_a=step3&amp;cart_order_id={DATA.cart_order_id}" class="txtDefault">{LANG_COMPLETE_PAYMENT}</a>
			<!-- END: make_payment -->
			<!-- BEGIN: courier_tracking -->
			<br />
			<a href="{TRACKING_URL}" class="txtSession" target="_blank">{LANG_COURIER_TRACKING}</a>
