<!-- BEGIN: view_order -->
	<div class="txtContentTitle">{LANG_YOUR_VIEW_ORDER}</div>
	 ...
	 <!-- BEGIN: repeat_products -->
	  <tr>
		...
		{VAL_PRODUCT_OPTS}
			<!-- BEGIN: digital_link -->
			<br />
			[<a href="{VAL_DOWNLOAD_LINK}" class="txtSession">{LANG_DOWNLOAD_LINK}</a>]
			<!-- END: digital_link -->		</td>
	  ...
	  <tr>
		...
		<table border="0" cellspacing="0" cellpadding="3">
          ...
          <tr>
            <td>&nbsp;</td>
            <td><a href="{VAL_SHIP_TRACK}" class="txtSession" target="_blank">{LANG_SHIP_TRACK}</a></td>
          </tr>
        </table></td>
