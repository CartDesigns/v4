...
<div class="txtContentTitle">{LANG_REGISTER}</div>
<div class="boxContent">
	...
	<table  border="0" cellspacing="0" cellpadding="3" width="100%">
	  ...
	  <tr>
	    ...
	    <td nowrap="nowrap"><input name="add_1" type="text" class="textbox" id="add_1" size="16" value="{VAL_ADD_1}" tabindex="7" />
{ICON_REQUIRED}</td>
	    </tr>
	  <tr>
	    ...
	    <td nowrap="nowrap"><input name="lastName" type="text" class="textbox" id="lastName" size="16" value="{VAL_LAST_NAME}" tabindex="3" />
	      {ICON_REQUIRED} </td>
		<td>&nbsp;</td>
		<td nowrap="nowrap"><input name="add_2" type="text" class="textbox" id="add_2" size="16" value="{VAL_ADD_2}" tabindex="8" /></td>
	  </tr>
	  <tr>
	    ...
	    <td nowrap="nowrap"><input name="email" type="text" class="textbox" id="email" size="16" value="{VAL_EMAIL}" tabindex="4" />
	      {ICON_REQUIRED} </td>
		<td>{LANG_TOWN}</td>
		<td nowrap="nowrap"><input name="town" type="text" class="textbox" id="town" size="16" value="{VAL_TOWN}" tabindex="9" />
{ICON_REQUIRED}</td>
	  </tr>
	  <tr>
	  ...
	  <tr>
		...
		<div id="divCountyText" {VAL_COUNTY_TXT_STYLE}>
		  <input name="county" type="text" class="textbox" id="county" value="{VAL_DEL_COUNTY}" maxlength="50"  tabindex="10" />
		</div>
	  ...
	  <tr>
		...
		<td nowrap="nowrap">&nbsp;</td>
	    <td>{LANG_POSTCODE}</td>
	    <td nowrap="nowrap"><input name="postcode" type="text" class="textbox" id="postcode" size="16" value="{VAL_POSTCODE}" tabindex="12" />
{ICON_REQUIRED}</td>
	  </tr>
	  <tr>
	  ...
	  <tr>
		...
		<td nowrap="nowrap"><input name="password" type="password" autocomplete="off" class="{VAL_PASS_CLASS}" id="password" size="16" value="{VAL_PASSWORD}" tabindex="13" /> 
		  <span id="password_required" {VAL_PASS_HIDE_REQUIRED}>{ICON_REQUIRED_SECURITY}</span> </td>
		<td>{LANG_CONFIRM_PASSWORD}</td>
		<td nowrap="nowrap"><input name="passwordConf" type="password" autocomplete="off" class="{VAL_PASS_CLASS}" id="passwordConf" size="16" value="{VAL_PASSWORD_CONF}" tabindex="14" /> 
	  ...
	  <tr>
		<td>{TXT_SPAMBOT}<br />
{IMG_SPAMBOT}</td>
		<td colspan="3"><input name="spamcode" type="text" class="textbox" value="" tabindex="15" size="5" maxlength="5" /> {ICON_REQUIRED}</td>
	  </tr>
	  <!-- END: spambot -->
	  
	  <!-- BEGIN: recaptcha -->
	  <tr>
		<td valign="top"><strong>{TXT_SPAMBOT}</strong></td>
	 ...
	 <!-- END: recaptcha -->
	  ...
	  <tr>
		<td colspan="2">{LANG_RECIEVE_EMAILS}
		  <input type="checkbox" name="optIn1st" value="1" tabindex="16" {VAL_OPTIN1ST_CHECKED}/></td>
	  ...
	  <tr>
		<td colspan="4">{LANG_PLEASE_READ} <a href="{LINK_TANDCS}" target="_blank" class="txtSession">{LANG_TANDCS}</a> <input type="checkbox" name="tandc" value="checkbox" /> {ICON_REQUIRED}</td>
		</tr>
	  <tr>
		<td colspan="4"><input name="ESC" type="hidden" value="{VAL_ESC}" /></td>
		</tr>
	  <tr>
		<td colspan="4" align="right"><a href="javascript:submitDoc('registerForm');" class="txtButton" tabindex="17">{LANG_REGISTER_SUBMIT}</a></td>
		</tr>
	</table>
