...
<table border="0" cellspacing="0" cellpadding="3" id="Profile">
<tr>
<td align="right"><strong>{TXT_TITLE}</strong></td>
<td><input name="title" type="text" class="textbox" id="title" value="{VAL_TITLE}" size="7" maxlength="30" /> {LANG_TITLE_DESC}</td>
</tr>
...
<td><input name="email" type="text" class="textbox" value="{VAL_EMAIL}" maxlength="100" /> *</td>
</tr>
