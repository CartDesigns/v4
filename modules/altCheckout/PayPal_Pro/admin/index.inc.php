...
<table border="0" cellspacing="1" cellpadding="3" class="mainTable" width="800">
  ...
  <?php 
  if(getCountryFormat($config['siteCountry'], 'id', 'iso') =="US") {
  ?>
  <tr>
  <td width="33%" align="left" class="tdText"><strong>American Express:</strong></td>
    <td class="tdText">
	<select name="module[amex]">
		<option value="1" <?php if(!isset($module['amex']) || $module['amex'] == 1) echo "selected='selected'"; ?>>Enabled</option>
		<option value="0" <?php if(isset($module['amex']) && $module['amex'] == 0) echo "selected='selected'"; ?>>Disabled</option>
	</select></td>
  </tr>
  <?php
  }
...
<table border="0" cellspacing="1" cellpadding="3" class="mainTable" width="800">
  ...
  <tr>
	...
	<td class="tdText"><input type="password" autocomplete="off" name="module[3ds_password]" value="<?php echo $module['3ds_password']; ?>" class="textbox" size="45" /></td>
  </tr>
  <tr>
