...
\"Denied.\"";
	...
	$txn_id = $db->select('SELECT `id` FROM '.$glob['dbprefix'].'CubeCart_transactions WHERE `trans_id` = '.$db->mySQLsafe($_POST['txn_id']));
	...
	// process payment
	if($success == true && $_POST['payment_status']=='Completed') {
