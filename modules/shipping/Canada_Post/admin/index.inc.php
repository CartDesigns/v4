...
<table border="0" cellspacing="1" cellpadding="3" class="mainTable">
  ...
  <tr>
	...
	<select name="module[status]">
		<option value="1" <?php if ($modLoad->settings['status']) echo "selected='selected'"; ?>><?php echo $lang['admin_common']['enabled']; ?></option>
		<option value="0" <?php if (!$modLoad->settings['status']) echo "selected='selected'"; ?>><?php echo $lang['admin_common']['disabled']; ?></option>
    </select>	</td>
  </tr>
    ...
    <tr>
      ...
      <td  class="tdText" colspan="9"><select name="module[debug]">
        <option value="1" <?php if($module['debug']==1) echo "selected='selected'"; ?>><?php echo $lang['admin_common']['enabled']; ?></option>
        <option value="0" <?php if($module['debug']==0) echo "selected='selected'"; ?>><?php echo $lang['admin_common']['disabled']; ?></option>
      </select></td>
    </tr>
