...
-->
    ...
    <tr>
   		<td colspan='3'>Global Express Guaranteed GXG</td> <td colspan='10'> <input name='module[GlobalExpressGuaranteedGXG]' type='checkbox' value='1' <?php if($module['GlobalExpressGuaranteedGXG']) echo 'checked=\'checked\'';?> /> </td>
   	</tr>
    <tr>
    	<td colspan='3'>Global Express Guaranteed Non-Document Rectangular</td> <td colspan='8'> <input name='module[GlobalExpressGuaranteedNonDocumentRectangular]' type='checkbox' value='1' <?php if($module['GlobalExpressGuaranteedNonDocumentRectangular']) echo 'checked=\'checked\'';?> /> </td>
    </tr>
    <tr>
    	<td colspan='3'>Global Express Guaranteed Non-Document Non-Rectangular</td> <td colspan='8'> <input name='module[GlobalExpressGuaranteedNonDocumentNonRectangular]' type='checkbox' value='1' <?php if($module['GlobalExpressGuaranteedNonDocumentNonRectangular']) echo 'checked=\'checked\'';?> /> </td>
    </tr>
    <tr>
    	<td colspan='3'>USPS GXG Envelopes</td> <td colspan='8'> <input name='module[USPSGXGEnvelopes]' type='checkbox' value='1' <?php if($module['USPSGXGEnvelopes']) echo 'checked=\'checked\'';?> /> </td>
    </tr>
    <tr>
    	<td colspan='3'>Express Mail International</td> <td colspan='8'> <input name='module[ExpressMailInternational]' type='checkbox' value='1' <?php if($module['ExpressMailInternational']) echo 'checked=\'checked\'';?> /> </td>
    </tr>
    <tr>
   		<td colspan='3'>Express Mail International Flat-Rate Envelope</td> <td colspan='8'> <input name='module[ExpressMailInternationalFlatRateEnvelope]' type='checkbox' value='1' <?php if($module['ExpressMailInternationalFlatRateEnvelope']) echo 'checked=\'checked\'';?> /> </td>
    </tr>
    <tr>
    	<td colspan='3'>Priority Mail International</td> <td colspan='8'> <input name='module[PriorityMailInternational]' type='checkbox' value='1' <?php if($module['PriorityMailInternational']) echo 'checked=\'checked\'';?> /> </td>
    </tr>
    <tr>
    	<td colspan='3'>Priority Mail International Flat-Rate Envelope</td> <td colspan='8'> <input name='module[PriorityMailInternationalFlatRateEnvelope]' type='checkbox' value='1' <?php if($module['PriorityMailInternationalFlatRateEnvelope']) echo 'checked=\'checked\'';?> /> </td>
    </tr>
    <tr>
    	<td colspan='3'>Priority Mail International Small Flat-Rate Box</td> <td colspan='8'> <input name='module[PriorityMailInternationalSmallFlatRateBox]' type='checkbox' value='1' <?php if($module['PriorityMailInternationalSmallFlatRateBox']) echo 'checked=\'checked\'';?> /> </td>
    </tr>
    <tr>
    	<td colspan='3'>Priority Mail International Medium Flat-Rate Box</td> <td colspan='8'> <input name='module[PriorityMailInternationalMediumFlatRateBox]' type='checkbox' value='1' <?php if($module['PriorityMailInternationalMediumFlatRateBox']) echo 'checked=\'checked\'';?> /> </td>
    </tr>
    <tr>
    	<td colspan='3'>Priority Mail International Large Flat-Rate Box</td> <td colspan='8'> <input name='module[PriorityMailInternationalLargeFlatRateBox]' type='checkbox' value='1' <?php if($module['PriorityMailInternationalLargeFlatRateBox']) echo 'checked=\'checked\'';?> /> </td>
    </tr>
    <tr>
    	<td colspan='3'>First Class Mail International Large Envelope</td> <td colspan='8'> <input name='module[FirstClassMailInternationalLargeEnvelope]' type='checkbox' value='1' <?php if($module['FirstClassMailInternationalLargeEnvelope']) echo 'checked=\'checked\'';?> /> </td>
    </tr>
    <tr>
    	<td colspan='3'>First Class Mail International Package</td> <td colspan='8'> <input name='module[FirstClassMailInternationalPackage]' type='checkbox' value='1' <?php if($module['FirstClassMailInternationalPackage']) echo 'checked=\'checked\'';?> /> </td>
    </tr>
    <tr>
